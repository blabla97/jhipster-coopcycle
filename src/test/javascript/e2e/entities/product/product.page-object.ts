...
export class ProductUpdatePage {
  ...
  basketsSelect = element(by.id('field_baskets'));
  ...
  getDisponibilityInput(): ElementFinder {
    return this.disponibilityInput;
  }
  ...
  async basketsSelectLastOption(): Promise<void> {
    await this.basketsSelect
      .all(by.tagName('option'))
      .last()
      .click();
  }

  async basketsSelectOption(option: string): Promise<void> {
    await this.basketsSelect.sendKeys(option);
  }

  getBasketsSelect(): ElementFinder {
    return this.basketsSelect;
  }

  async getBasketsSelectedOption(): Promise<string> {
    return await this.basketsSelect.element(by.css('option:checked')).getText();
  }
