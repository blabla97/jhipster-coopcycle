...
public class RestaurantResourceIT {
    ...
    private static final String DEFAULT_TEL = "0218917653";
    private static final String UPDATED_TEL = "+33398069979";
    ...
    public static Restaurant createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, RestaurantOwner.class).isEmpty()) {
            restaurantOwner = RestaurantOwnerResourceIT.createEntity(em);
            em.persist(restaurantOwner);
            em.flush();
        } else {
            restaurantOwner = TestUtil.findAll(em, RestaurantOwner.class).get(0);
        }
        restaurant.setRestaurants(restaurantOwner);
        return restaurant;
    }
    /**
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        ...
        RestaurantOwner restaurantOwner;
        if (TestUtil.findAll(em, RestaurantOwner.class).isEmpty()) {
            restaurantOwner = RestaurantOwnerResourceIT.createUpdatedEntity(em);
            em.persist(restaurantOwner);
            em.flush();
        } else {
            restaurantOwner = TestUtil.findAll(em, RestaurantOwner.class).get(0);
