...
public class ProductResourceIT {
    ...
    private static final Boolean DEFAULT_DISPONIBILITY = false;
    private static final Boolean UPDATED_DISPONIBILITY = true;
    ...
    public static Product createEntity(EntityManager em) {
        ...
        product.setProducts(restaurant);
        // Add required entity
        Basket basket;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.isDisponibility()).isEqualTo(DEFAULT_DISPONIBILITY);
    }
    ...
    @Test
    @Transactional
    public void checkDisponibilityIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].disponibility").value(hasItem(DEFAULT_DISPONIBILITY.booleanValue())));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.isDisponibility()).isEqualTo(UPDATED_DISPONIBILITY);
    }
